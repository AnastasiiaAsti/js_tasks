...
// If properly set, it should correctly calculate the damage after an attack(if the attacker 
// position is == to the block position of the defender: 
// no damage; otherwise, the defender gets 10 damage if hit "high" or 5 damage if hit "low".
...
// Notice that health can't be below 0: once hit to 0 health, 
// a warrior attribute deceased becomes true; if hit again, the zombie attribute becomes 
// true too!
